    ...
    <div class="container mt-4">
        ...
        <div class="mt-5 row-gap-5 d-flex justify-content-between flex-wrap border border-success p-5">
            <div class="col-6 container">
                <h2>Cliente</h2>
                <a href="/Cliente/visualizar" class="btn btn-secondary ">Visualizar</a>
                <a href="/Cliente/inserir" class="btn btn-success ">Adicionar</a>
            </div>
            <div class="col-6 container">
                <h2>Produto</h2>
                <a href="/Produto/visualizar" class="btn btn-secondary ">Visualizar</a>
                <a href="/Produto/inserir" class="btn btn-success ">Adicionar</a>
            </div>
            <div class="col-6 container">
                <h2>Pedido</h2>
                <a href="/Pedido/visualizar" class="btn btn-secondary ">Visualizar</a>
                <a href="/Pedido/inserir" class="btn btn-success ">Adicionar</a>
            </div>
            <div class="col-6 container">
                <h2>Itens do Pedido</h2>
                <a href="PedidoItem/visualizar" class="btn btn-secondary ">Visualizar</a>
