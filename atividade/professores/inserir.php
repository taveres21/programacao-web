<?php
  ...
  function inserirProfessor($nome, $formacao, $telefone, $email, $aluno_id){
    global $pdo;
    $sql = "INSERT INTO professores (nome, formacao, telefone, email, aluno_id) 
    VALUES (:nome, :formacao, :telefone, :email, :aluno_id)";
    $stm = $pdo->prepare($sql);
  ...
  <body class="container">
    ...
    <form action="inserir.php" method="POST">
      <div class="row">
        ...
        <div class="col-5">
          <label for="curso" class="form-label">Informe o código do aluno:</label>
